...
import com.atguigu.gulimallseckill.fegin.CouponFeignService;
import com.atguigu.gulimallseckill.fegin.ProductFeignService;
...
import com.atguigu.gulimallseckill.vo.SeckillSessionWithSkusVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void uploadSeckillSkuLatest3Days() {
        ...
        if (lates3DaySession.getCode1() == 0) {
            //上架商品
    ...
    public String kill(String killId, String key, Integer num) throws InterruptedException {
        ...
        if (currentTime >= startTime && currentTime <= endTime) {
            ...
            if (randomCode.equals(key) && killId.equals(skuId)) {
                ...
                int seckillLimit = redisTo.getSeckillLimit().intValue();
